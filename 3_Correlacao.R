...
dados_bancodados<-read.csv2("C:/Livro_Lidar/Item6_Metricas/Item_6_Tabelas/DADOS_METRICAS_PARCELAS.csv", header = TRUE)
...
write.csv2(dados_cor,"C:/Livro_Lidar/Item6_Metricas/Item_6_Tabelas/dados_pareados.csv")
...
write.csv2(correlacao,"C:/Livro_Lidar/Item6_Metricas/Item_6_Tabelas/correlacao.csv")

#Construindo a matriz de correlacao entre as variaveis
res1 <- cor.mtest(correlacao, conf.level = .05)
jpeg("C:/Livro_Lidar/Item6_Metricas/Item_6_Imagens/correlacao.jpeg", width = 5800, height = 5000, units = "px", res = 300, quality = 5000)
